...
#endif
    const char* text = "云耀可以称为所有精王武器中最具有传奇色彩的一柄——并不是因为它本身的力量，而是因为那个神话般的持有者。几百年前，雅加西所使用的武器是一柄名为“天驱”的软剑，为女神菲娜所赠。然而，由于莫巴帝的背叛，菲娜在与世界树融合之际惨遭毁灭的命运，追随她的血族们也大都死在使徒的剑下，从此一蹶不振。而随着女神香消玉殆，神剑中的力量也开始缓慢地衰竭。数百年之后的路维丝时代，传说中的皇帝遇到了精灵黎瑟西尔，而当他为了黎瑟不惜同时对抗三千名精灵族高阶战士时，“天驱”终于耗尽了最后一份力量，断为无数碎片。\n"
